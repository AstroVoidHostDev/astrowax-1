...
// ============================================
// AstroWax Panel V1.80 — Server View
// ============================================
          ...
          {tabs.map(tab => {
             ...
             return (
              <Link 
                ...
                to={tab.path}
                onClick={() => setSidebarOpen(false)}
                className={`flex items-center space-x-3 px-3 py-2.5 text-sm font-medium transition-all rounded-lg ${isActive ? 'bg-theme-600/20 text-theme-300 shadow-sm border border-theme-600/30' : 'text-muted-foreground hover:text-foreground-muted hover:bg-white/[0.05] border border-transparent'}`}
              >
